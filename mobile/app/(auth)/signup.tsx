    ...
    >
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Join Trackstar today</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View style={[
            styles.inputContainer, 
            { backgroundColor: colors.card, borderColor: colors.border },
            focusedField === 'confirmPassword' && { borderColor: colors.borderFocused }
          ]}>
            <Ionicons name="lock-closed-outline" size={20} color={focusedField === 'confirmPassword' ? colors.borderFocused : colors.iconMuted} style={styles.inputIcon} />
            <TextInput
              style={[styles.input, { color: colors.text }]}
              ...
              onBlur={() => setTimeout(() => setFocusedField(prev => prev === 'confirmPassword' ? null : prev), 0)}
            />
          </View>
